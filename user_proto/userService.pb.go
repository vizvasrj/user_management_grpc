...
var file_userService_proto_rawDesc = []byte{
	...
	0x61, 0x22, 0x3c, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x43, 0x72, 0x69, 0x74, 0x65,
...
var file_userService_proto_depIdxs = []int32{
	3, // 0: user.SearchUsersRequest.criteria:type_name -> user.SearchCriteria
	4, // 1: user.Users.users:type_name -> user.User
	0, // 2: user.UserService.GetUserById:input_type -> user.GetUserByIdRequest
	1, // 3: user.UserService.GetUsersByIds:input_type -> user.GetUsersByIdsRequest
	2, // 4: user.UserService.SearchUsers:input_type -> user.SearchUsersRequest
	4, // 5: user.UserService.GetUserById:output_type -> user.User
	5, // 6: user.UserService.GetUsersByIds:output_type -> user.Users
	5, // 7: user.UserService.SearchUsers:output_type -> user.Users
